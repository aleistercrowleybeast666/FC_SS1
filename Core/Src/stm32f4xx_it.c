...
void EXTI9_5_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(GNSS_EXTINT_Pin);
  HAL_GPIO_EXTI_IRQHandler(PRESSURE_INT_Pin);
  HAL_GPIO_EXTI_IRQHandler(IMU1_INT1_Pin);
  HAL_GPIO_EXTI_IRQHandler(IMU1_INT2_Pin);
  HAL_GPIO_EXTI_IRQHandler(IMU1_INT3_Pin);
...
void EXTI15_10_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(IMU1_INT4_Pin);
